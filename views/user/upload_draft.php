                            ...
                            <div class="card" style="height: 500px; overflow-y: auto;">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="../../models/DraftModel.php" enctype="multipart/form-data">
                                        ...
                                        <textarea class="form-control mb-3" id="dasar_hukum" name="dasar_hukum" readonly><?php echo isset($data['dasar_hukum']) ? htmlspecialchars(strip_tags($data['dasar_hukum'])) : ''; ?></textarea>

                                        <label for="gambaran_umum"><strong>Gambaran Umum</strong></label>
                                        <textarea class="form-control mb-3" id="gambaran_umum" name="gambaran_umum" readonly><?php echo isset($data['gambaran_umum']) ? htmlspecialchars(strip_tags($data['gambaran_umum'])) : ''; ?></textarea>

                                        <label for="tujuan"><strong>Tujuan</strong></label>
                                        <textarea class="form-control mb-3" id="tujuan" name="tujuan" readonly><?php echo isset($data['tujuan']) ? htmlspecialchars(strip_tags($data['tujuan'])) : ''; ?></textarea>

                                        <label for="target_sasaran"><strong>Target/Sasaran</strong></label>
                                        <textarea class="form-control mb-3" id="target_sasaran" name="target_sasaran" readonly><?php echo isset($data['target_sasaran']) ? htmlspecialchars(strip_tags($data['target_sasaran'])) : ''; ?></textarea>

                                        <label for="unit_kerja"><strong>Unit Kerja Pelaksana</strong></label>
                                        <textarea class="form-control mb-3" id="unit_kerja" name="unit_kerja" readonly><?php echo isset($data['unit_kerja']) ? htmlspecialchars(strip_tags($data['unit_kerja'])) : ''; ?></textarea>

                                        <label for="ruang_lingkup"><strong>Ruang Lingkup, Lokasi dan Fasilitas Penunjang</strong></label>
                                        <textarea class="form-control mb-3" id="ruang_lingkup" name="ruang_lingkup" readonly><?php echo isset($data['ruang_lingkup']) ? htmlspecialchars(strip_tags($data['ruang_lingkup'])) : ''; ?></textarea>

                                        <label for="produk_jasa_dihasilkan"><strong>Produk/Jasa yang dihasilkan (Deliverable)</strong></label>
                                        <textarea class="form-control mb-3" id="produk_jasa_dihasilkan" name="produk_jasa_dihasilkan" readonly><?php echo isset($data['produk_jasa_dihasilkan']) ? htmlspecialchars(strip_tags($data['produk_jasa_dihasilkan'])) : ''; ?></textarea>

                                        <label for="waktu_pelaksanaan"><strong>Waktu Pelaksanaan</strong></label>
                                        <textarea class="form-control mb-3" id="waktu_pelaksanaan" name="waktu_pelaksanaan" readonly><?php echo isset($data['waktu_pelaksanaan']) ? htmlspecialchars(strip_tags($data['waktu_pelaksanaan'])) : ''; ?></textarea>

                                        <label for="tenaga_ahli_terampil"><strong>Tenaga Ahli</strong></label>
                                        <textarea class="form-control mb-3" id="tenaga_ahli_terampil" name="tenaga_ahli_terampil" readonly><?php echo isset($data['tenaga_ahli_terampil']) ? htmlspecialchars(strip_tags($data['tenaga_ahli_terampil'])) : ''; ?></textarea>

                                        <label for="peralatan"><strong>Peralatan</strong></label>
                                        <textarea class="form-control mb-3" id="peralatan" name="peralatan" readonly><?php echo isset($data['peralatan']) ? htmlspecialchars(strip_tags($data['peralatan'])) : ''; ?></textarea>

                                        <label for="metode_kerja"><strong>Metode Kerja</strong></label>
                                        <textarea class="form-control mb-3" id="metode_kerja" name="metode_kerja" readonly><?php echo isset($data['metode_kerja']) ? htmlspecialchars(strip_tags($data['metode_kerja'])) : ''; ?></textarea>

                                        <label for="manajemen_resiko"><strong>Manajemen Resiko</strong></label>
                                        <textarea class="form-control mb-3" id="manajemen_resiko" name="manajemen_resiko" readonly><?php echo isset($data['manajemen_resiko']) ? htmlspecialchars(strip_tags($data['manajemen_resiko'])) : ''; ?></textarea>

                                        <label for="laporan_pengajuan_pekerjaan"><strong>Laporan Pengajuan Pekerjaan</strong></label>
                                        <textarea class="form-control mb-3" id="laporan_pengajuan_pekerjaan" name="laporan_pengajuan_pekerjaan" readonly><?php echo isset($data['laporan_pengajuan_pekerjaan']) ? htmlspecialchars(strip_tags($data['laporan_pengajuan_pekerjaan'])) : ''; ?></textarea>

                                        <label for="sumber_dana_prakiraan_biaya"><strong>Sumber Dana dan Prakiraan Biaya</strong></label>
                                        <textarea class="form-control mb-3" id="sumber_dana_prakiraan_biaya" name="sumber_dana_prakiraan_biaya" readonly><?php echo isset($data['sumber_dana_prakiraan_biaya']) ? htmlspecialchars(strip_tags($data['sumber_dana_prakiraan_biaya'])) : ''; ?></textarea>

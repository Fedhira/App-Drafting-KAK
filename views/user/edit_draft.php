                            ...
                            <div class="card" style="height: 500px; overflow-y: auto;">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="../../models/DraftModel.php" enctype="multipart/form-data">
                                        ...
                                        <input type="text" id="indikator" name="indikator" class="form-control mb-3" value="<?php echo htmlspecialchars($data['indikator']); ?>">

                                        <label for="satuan_ukur"><strong>Satuan Ukur / Jenis Keluaran</strong></label>
                                        <input type="text" id="satuan_ukur" name="satuan_ukur" class="form-control mb-3" value="<?php echo htmlspecialchars($data['satuan_ukur']); ?>">

                                        <label for="volume"><strong>Volume</strong></label>
                                        <input type="text" id="volume" name="volume" class="form-control mb-3" value="<?php echo htmlspecialchars($data['volume']); ?>">
                                        ...
                                        <div class="mt-4 text-end">
                                            <button type="submit" class="btn btn-primary me-2" value="Submit">Simpan</button>

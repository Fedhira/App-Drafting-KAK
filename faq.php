            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    <ul class="nav nav-secondary">
                        ...
                        <li class="nav-item"><a href="users.html"><i class="fas fa-user-group"></i>
                                <p>Users</p>
                            </a></li>
                        <li class="nav-item"><a href="kategori.html"><i class="fas fa-border-all"></i>
                                <p>Kategori Program</p>
                            </a></li>
                        <li class="nav-item"><a href="daftar.html"><i class="fa-sharp fa-solid fa-clipboard-list"></i>
                                <p>Daftar KAK</p>
                            </a></li>
                        <li class="nav-item"><a href="laporan.html"><i class="fas fa-file"></i>
                                <p>Laporan</p>
                            </a></li>
                        <li class="nav-item"><a href="widgets.html"><i class="fas fa-right-from-bracket"></i>
                                <p>Logout</p>
                            </a></li>
                    </ul>
                </div>
